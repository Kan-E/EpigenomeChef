---
title: "Pair-wise analysis with EpigenomeChef v1.1.5"
...
params:
    ...
    annotation_test: [some object]
    dir_name_annotation: [some object]
    annotation_group: [some object]
...
```
 ...
 - Volcano plot (DMR_result/volcano_plot.pdf)
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", echo=FALSE}
if(!is.null(params$input$xrange)){
try(magick::image_read_pdf("./DMR_result/volcano_plot.pdf"))
}else print("No plot")
```
 
 - Result table (DMR_result/DMR_result.txt)
 - Up DMR (DMR_result/`r unique(params$collist_bw_pair)[2]`_high.bed)
 - Down DMR (DMR_result/`r unique(params$collist_bw_pair)[1]`_high.bed)
\newpage
...
if(params$input$Species != "not selected"){
          if(params$input$Genomic_region == "Genome-wide"){
            try(magick::image_read_pdf(paste0("./annotation/summary.pdf")))
          }}else print("No plot")
```
```{r echo = FALSE}
try(knitr::kable(head(params$annotation_test)))
cat("\n\n")
```

\newpage

Annotation and histogram of each group (`r params$dir_name_annotation`)

- all peak

```{r, out.width="50%", include=TRUE, fig.align="center", echo=FALSE}
if(params$input$Species != "not selected"){
          if(params$input$Genomic_region == "Genome-wide"){
            try(magick::image_read_pdf(paste0("./annotation/all_peak.pdf")))
          }}else print("No plot")
```
```{r, out.width="50%", include=TRUE, fig.align="center", echo=FALSE}
if(params$input$Species != "not selected"){
          if(params$input$Genomic_region == "Genome-wide"){
              try(magick::image_read_pdf(paste0("./",params$dir_name_annotation,"all_peak.pdf")))
          }}else print("No plot")
```

- `r unique(params$collist_bw_pair)[2]`_high peaks

```{r, out.width="50%", include=TRUE, fig.align="center", echo=FALSE}
if(params$input$Species != "not selected"){
          if(params$input$Genomic_region == "Genome-wide"){
            try(magick::image_read_pdf(paste0("./annotation/",
                                              unique(params$collist_bw_pair)[2],"_high.pdf")))
          }}else print("No plot")
```
```{r, out.width="50%", include=TRUE, fig.align="center", echo=FALSE}
if(params$input$Species != "not selected"){
          if(params$input$Genomic_region == "Genome-wide"){
              try(magick::image_read_pdf(paste0("./",params$dir_name_annotation,
                                                unique(params$collist_bw_pair)[2],"_high.pdf")))
          }}else print("No plot")
```

- `r unique(params$collist_bw_pair)[1]`_high peaks

```{r, out.width="50%", include=TRUE, fig.align="center", echo=FALSE}
if(params$input$Species != "not selected"){
          if(params$input$Genomic_region == "Genome-wide"){
            try(magick::image_read_pdf(paste0("./annotation/",
                                              unique(params$collist_bw_pair)[1],"_high.pdf")))
          }}else print("No plot")
cat("\n\n")
```
```{r, out.width="50%", include=TRUE, fig.align="center", echo=FALSE}
...
## Peak pattern
 ...
 - Peak pattern of `r unique(params$collist_bw_pair)[2]`_high peaks (line plot: peak_pattern/`r unique(params$collist_bw_pair)[2]`_high_lineplot.pdf, heatmap: peak_pattern/`r unique(params$collist_bw_pair)[2]`_high_heatmap.pdf)
...
```
 ...
 - Peak pattern of `r unique(params$collist_bw_pair)[1]`_high peaks (line plot: peak_pattern/`r unique(params$collist_bw_pair)[1]`_high_lineplot.pdf, heatmap: peak_pattern/`r unique(params$collist_bw_pair)[1]`_high_heatmap.pdf)
...
- known motif of `r unique(params$collist_bw_pair)[2]`_high peak (`r params$base_dir`/`r unique(params$collist_bw_pair)[2]`_high/knownResults.html)
...
- known motif of `r unique(params$collist_bw_pair)[1]`_high peak (`r params$base_dir`/`r unique(params$collist_bw_pair)[1]`_high/knownResults.html)
...
- unknown motif of `r unique(params$collist_bw_pair)[2]`_high peak (`r params$base_dir`/`r unique(params$collist_bw_pair)[2]`_high/homerResults.html)
...
- unknown motif of `r unique(params$collist_bw_pair)[1]`_high peak (`r params$base_dir`/`r unique(params$collist_bw_pair)[1]`_high/homerResults.html)
...
- RP_definition: `r params$input$RNAseq_mode_option`
