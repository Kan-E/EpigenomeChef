...
---
```{r echo = FALSE}
try(webshot("http://www.rstudio.com/",file="img1.png"))
```
## Parameters
 - Uploaded file name:
```{r echo = FALSE}
...
```{r echo = FALSE}
if(params$input$Species != "not selected" && !is.null(params$input$Gene_set) && params$input$Genomic_region == "Genome-wide"){
table <- as.data.frame(params$region_gene_associate)
table$Group <- gsub("\n","",table$Group)
knitr::kable(table)
}
```
...
- known motif of up DAR (`r params$base_dir`/Up/knownResults.html)
...
- unknown motif of up DAR (`r params$base_dir`/Up/homerResults.html)

```{r echo=FALSE}
if(params$input$motifButton > 0 && !is.null(params$enrich_motif) && 
             params$input$homer_unknown == "known and de novo motifs"){
webshot(paste0("./",params$enrich_motif[[1]],"/homerResults.html"),file="img3.png")
          }else print("Not performed")
```
...
if(params$input$motifButton > 0 && !is.null(params$enrich_motif) && 
             params$input$homer_unknown == "known and de novo motifs"){
webshot(paste0("./",params$enrich_motif[[2]],"/homerResults.html"),file="img4.png")
          }else print("Not performed")
```
