...
try(magick::image_read_pdf("./peak_distribution/up_annotation.pdf"))
          }}else print("No plot")
```
...
if(params$input$Species != "not selected"){
          if(params$input$Genomic_region == "Genome-wide"){
try(magick::image_read_pdf("./peak_distribution/down_annotation.pdf"))
          }}else print("No plot")
```
...
```{r echo = FALSE}
try(knitr::kable(as.data.frame(params$enrichment_1_1)))
```
